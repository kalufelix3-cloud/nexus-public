...
import static org.sonatype.nexus.elasticsearch.internal.files.FileDescriptorServiceImpl.MINIMUM_FILE_DESCRIPTOR_COUNT;
import static org.sonatype.nexus.elasticsearch.internal.files.FileDescriptorServiceImpl.NOT_SUPPORTED;
import static org.sonatype.nexus.elasticsearch.internal.files.FileDescriptorServiceImpl.WARNING_HEADER;
import static org.sonatype.nexus.elasticsearch.internal.files.FileDescriptorServiceImpl.WARNING_URL;
import static org.sonatype.nexus.elasticsearch.internal.files.FileDescriptorServiceImpl.WARNING_VIOLATION;
    ...
    extends TestSupport
{
      ...
      implements FileDescriptorProvider
  {
    ...
    FileDescriptorProvider with(final long override) {
  ...
  {
    TestFileDescriptorService(final FileDescriptorProvider fileDescriptorProvider) {
